...
class SolitaireMancala:
    ...
    def plan_moves(self):
        ...
        """
        test = list(self.board)
        obj_list = SolitaireMancala()
        obj_list.set_board(test)
        
        move_plan = []
        while not obj_list.choose_move() == 0:
            move_plan.append(obj_list.choose_move())
            obj_list.apply_move(obj_list.choose_move())
